              ...
              {showContact && (
                ...
                >
                  <div className="flex flex-col">
                    ...
                    <button onClick={() => window.location.href = 'mailto:athulvikram012@gmail.com'} className="group text-sm text-zinc-300 hover:text-white transition-colors font-medium break-all lowercase flex items-center gap-3 cursor-pointer text-left w-full">
                  ...
                  <div className="flex flex-col">
                    ...
                    <button onClick={() => window.open('https://wa.me/917306483636', '_blank', 'noopener,noreferrer')} className="group text-sm text-zinc-300 hover:text-white transition-colors font-medium flex items-center gap-3 cursor-pointer text-left w-full">
